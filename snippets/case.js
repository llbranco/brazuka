...
async function switchcase(infor2, client, brazuka4) {
  let infor3 = { ...infor2 };
  arg = infor3.arg;
  from = infor3.from;
  const brazuka3 = {
  ...
  if (infor3.from.endsWith("@g.us") && infor3.isMedia && infor3.groupdata.autosticker && infor3.arg[0] !== "sticker") {
    ...
    stickermaker(infor3, client, brazuka3).then(() => {
      count(infor3, 2)
    })
      .catch((err) => {
        console.log(err);
  ...
  switch (arg[0]) {
    ...
    case "invite":
      joingroup(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((err) => {
    ...
    case "run":
      coderunner(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((err) => {
    ...
    case "delete":
      deleteit(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((err) => {
    ...
    case "sourcecode":
      ...
      sourcecode(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((error) => {
    ...
    case "tweet":
      xdafootball(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((error) => {
    ...
    case "shorturl":
      shorturl(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((error) => {
    ...
    case "sticker":
      stickermaker(infor3, client, brazuka3)
        .then(() => {
          console.log("sent");
          count(infor3)
        })
    ...
    case "rs":
    case "rashmika":
      savedsticker(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((error) => {
    ...
    case "pin":
      pinterest(infor3, client, brazuka3)
        .then(() => {
          count(infor3)
        })
        .catch((error) => {
    ...
    case "ytv":
      youtube(infor3, client, brazuka3)
        .then((resolve) => {
          count(infor3)
        })
        .catch((error) => {
